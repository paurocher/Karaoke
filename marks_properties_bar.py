...
class MarksPropertiesBar():
    def __init__(self):
        ...
        self.text_surf = font.render("marks_properties",
                                     True,
                                     font_color,
                                     bg_color)
    ...
    def draw(self):
        ...
        surf_bg = pg.Surface((window_rect[2], 15))
        ...
        rect_bg.topleft = (0,
                           utils.WINDOW_ELEMENTS["WAVE"].rect_scaled[3] +
                           utils.WINDOW_ELEMENTS["MENU_BAR"].thickness +
                           utils.WINDOW_ELEMENTS["MARKS_AUDIO_BAR"].thickness)
